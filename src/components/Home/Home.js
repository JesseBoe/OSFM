                ...
                <div className="container mt-4">
                    <div className="card text-left bg-dark">
                        ...
                        <div className='card-body text-white'>
                            ...
                            <p className="text-about">Welcome to One Step From Modding! My online name is Sunreal. OSFE is the first game I have ever modded. I wanted to share some of the things I have learned here with you! I am by no means an expert, but my hope is that I can help inspire people to get creative. Simply click on the navbar in the top left to get started.</p>
